...
class PopularPosterShow extends StatefulWidget {
  ...
  @override
  _PopularPosterShowState createState() => _PopularPosterShowState();
}

class _PopularPosterShowState extends State<PopularPosterShow> {
  @override
  void initState() {
    super.initState();
